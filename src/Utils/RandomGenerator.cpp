...
pcg32 RandomGenerator::s_engine = pcg32(1);
std::uniform_real_distribution<float> RandomGenerator::s_floatDistribution = std::uniform_real_distribution<float>{ 0.f, 1.f };
